...
for num in range(no_of_invaders):
    invaderImage.append(pygame.image.load('spaceInvaders/data/alien.png'))
...
bulletImage = pygame.image.load('spaceInvaders/data/bullet.png')
bullet_X = 0
bullet_Y = 500
bullet_Xchange = 0
bullet_Ychange = 3
            ...
            if abs(player_X-invader_X[i]) < 80:
                for j in range(no_of_invaders):
                    ...
                    explosion_sound = mixer.Sound(
                        'spaceInvaders/data/explosion.wav')
